...
class Config:
    ...
    def __post_init__(self):
        ...
        versions = {
            ...
            "livecodebench": ("livecodebench-reference-v1", "livecodebench-dag-v1", "livecodebench-editorial-pilot-v1", "calibri-lcb-normalize-v1", "calibri-lcb-normalize-v2", "calibri-lcb-normalize-v3", "calibri-lcb-repair-v1", "calibri-lcb-repair-v2", "t2ance-lcb-normalize-v1", "t2ance-lcb-normalize-v2", "t2ance-lcb-normalize-v3", "t2ance-lcb-normalize-v4", "lcb-dag-revision-v1", "lcb-dag-revision-v2"),
        }[self.task_type]
        ...
        if self.prompt_version in ("lcb-dag-revision-v1", "lcb-dag-revision-v2"):
