...
def stages_for(config):
    if config.task_type == "livecodebench":
        ...
        if config.prompt_version in ("calibri-lcb-normalize-v1", "calibri-lcb-normalize-v2", "calibri-lcb-normalize-v3", "t2ance-lcb-normalize-v1", "t2ance-lcb-normalize-v2", "t2ance-lcb-normalize-v3"):
...
def prompt(
    ...
    if task_type == "livecodebench":
        if not ((version == "livecodebench-reference-v1" and stage == "reference_code")
                ...
                or (version in ("calibri-lcb-normalize-v1", "calibri-lcb-normalize-v2", "calibri-lcb-normalize-v3", "t2ance-lcb-normalize-v1", "t2ance-lcb-normalize-v2", "t2ance-lcb-normalize-v3")
